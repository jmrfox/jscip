...
def test_instance_to_theta_with_vectors():
    ...
    bank = ParameterBank(
        parameters={"scalar": scalar, "vector": vector}, theta_sampling=False
    )
...
def test_theta_to_instance_with_vectors():
    ...
    bank = ParameterBank(
        parameters={"scalar": scalar, "vector": vector}, theta_sampling=True
    )
...
def test_roundtrip_conversion_with_vectors():
    ...
    bank = ParameterBank(
        parameters={"vector": vector, "scalar": scalar}, theta_sampling=False
    )
...
def test_derived_parameter_with_vector_input():
    ...
    position = IndependentVectorParameter(
        value=[3.0, 4.0], is_sampled=True, range=(0.0, 10.0)
    )
...
def test_theta_dimensions_with_vectors():
    ...
    bank = ParameterBank(
        parameters={"s1": s1, "v1": v1, "v2": v2}, theta_sampling=False
    )
